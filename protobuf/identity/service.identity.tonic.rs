        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/service.identity.IdentityService/Register",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("service.identity.IdentityService", "Register"));
        ...
        pub async fn login(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/service.identity.IdentityService/Login",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("service.identity.IdentityService", "Login"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/service.identity.IdentityService/GetProfile",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("service.identity.IdentityService", "GetProfile"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/service.identity.IdentityService/ListOrganizations",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod identity_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/service.identity.IdentityService/Login" => {
                    #[allow(non_camel_case_types)]
                    struct LoginSvc<T: IdentityService>(pub Arc<T>);
                    impl<
                        T: IdentityService,
                    > tonic::server::UnaryService<super::LoginRequest> for LoginSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as IdentityService>::login(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/service.identity.IdentityService/GetProfile" => {
                    #[allow(non_camel_case_types)]
                    struct GetProfileSvc<T: IdentityService>(pub Arc<T>);
                    impl<
                        T: IdentityService,
                    ...
                    for GetProfileSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as IdentityService>::get_profile(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/service.identity.IdentityService/ListOrganizations" => {
                    #[allow(non_camel_case_types)]
                    struct ListOrganizationsSvc<T: IdentityService>(pub Arc<T>);
                    impl<
                        T: IdentityService,
                    ...
                    for ListOrganizationsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as IdentityService>::list_organizations(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "service.identity.IdentityService";
